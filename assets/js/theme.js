...
function switchLightMode(){
	...
	document.querySelector('html').style.setProperty('--bg-mask', 'linear-gradient(to top, rgba(255, 158, 189, 0.6), 19%, rgba(255, 255, 255, 0.95))');
